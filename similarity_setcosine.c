...
idpairs_t* similarity_setcosine_calculate(int uid, int k, void* args) {
    recdata_t* recdata;
    int* coo;
    idpairs_t* ud;
    idpairs_t* id;
...
void similarity_setcosine_close(void* args) {
    (void) args;
    return;
}
...
similarity_t* similarity_setcosine_create(recdata_t* recdata) {
    ...
    similarity->calculate = similarity_setcosine_calculate;
    similarity->close = similarity_setcosine_close;
